...
(
    ...
    `first_picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci      DEFAULT NULL COMMENT '文章首图，用于随机文章展示',
...
(
    ...
    `parent_comment_nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '被回复昵称',
...
#                               `id` bigint(0) NOT NULL AUTO_INCREMENT,
#                               `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '请求接口',
#                               `class_method` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '请求方式',
#                               `args` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '请求参数',
